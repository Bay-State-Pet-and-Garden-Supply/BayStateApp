...
export default async function ScraperDetailPage({ params }: PageProps) {
  ...
  const config = {
    ...
    selectors: (scraper.selectors as unknown as any[]) || (dbConfig.selectors as any[]) || [],
    workflows: (scraper.workflows as unknown as any[]) || (dbConfig.workflows as any[]) || [],
    ...
    login: (scraper.login as unknown as any) || (dbConfig.login as any),
    validation: (scraper.validation as unknown as any) || (dbConfig.validation as any),
  } as ScraperConfig;
